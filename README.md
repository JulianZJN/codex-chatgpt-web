...
- **Local usage statistics.** The sidebar's Statistics page shows 7/30-day activity by tier, separate GPT-5.6 Pro daily and GPT-6 Pro weekly counts, and Pro lifetime totals. These are local accepted-message counts, not official remaining allowances. See [counting and privacy](docs/local-usage-statistics.md).
